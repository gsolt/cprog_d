...
sT[0].sTI[2].nType = TYP_TMOK;
	...
	sT[0].sMOT[2].nIEC_NM				= 815;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[2].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[3].nType = TYP_TMOK;
	...
	sT[0].sMOT[3].nIEC_NM				= 895;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[3].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[5].nType = TYP_TMOK;
	...
	sT[0].sMOT[5].nIEC_NM				= 827;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[5].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[6].nType = TYP_TMOK;
	...
	sT[0].sMOT[6].nIEC_NM				= 831;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[6].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[56].nType = TYP_TMOK;
	...
	sT[0].sMOT[56].nIEC_NM				= 847;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[56].nNMNum      			= 4;	
...
sT[0].sTI[57].nType = TYP_TMOK;
	...
	sT[0].sMOT[57].nIEC_NM				= 851;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[58].nType = TYP_TMOK;
	...
	sT[0].sMOT[58].nIEC_NM				= 855;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[58].nNMNum      			= 4;	
...
sT[0].sTI[59].nType = TYP_TMOK;
	...
	sT[0].sMOT[59].nIEC_NM				= 859;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[59].nNMNum      			= 4;
...
sT[0].sTI[61].nType = TYP_TMOK;
	...
	sT[0].sMOT[61].nIEC_NM				= 835;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[61].nNMNum      			= 4;
...
sT[0].sTI[62].nType = TYP_TMOK;
	...
	sT[0].sMOT[62].nIEC_NM				= 867;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[64].nType = TYP_TMOK;
	...
	sT[0].sMOT[64].nIEC_NM				= 875;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[64].nNMNum				  = 4;		/* Analóg mérések száma*/
...
sT[0].sTI[66].nType = TYP_TMOK;
	...
	sT[0].sMOT[66].nIEC_NM				= 819;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[66].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[67].nType = TYP_TMOK;
	...
	sT[0].sMOT[67].nIEC_NM				= 823;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[67].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[174].nType = TYP_TMOK;
	...
	sT[0].sMOT[174].nIEC_NM				= 891;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[174].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[210].nType = TYP_TMOK;
	...
	sT[0].sMOT[210].nIEC_NM				= 839;		/* Mérések IEC kezdõcíme */
